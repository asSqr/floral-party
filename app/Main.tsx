      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pb-8 pt-6 md:space-y-5">
          ...
          <p className="pt-10 pb-10 text-lg leading-7 text-gray-900 dark:text-gray-100">
            「花を見る会」は毎月主に東京都内で交流しながら花を鑑賞しお茶をする、誰でも参加可能な会です。花に詳しい必要もなく、学生・社会人問わず誰でも気軽に参加することができます。アドバイザーによる解説付きです。
            <br />
            ...
            <br /> <br />
            「花を見る会」でいろいろな花を見るようになってから、自然はこんなに美しいのかと気づきました。花の名前もわかるようになり、他の場所でも目につくようになりました。
            <br />
            自然の趣深さを感じるいい機会を作るイベントなのではないかと思っています。
          </p>
