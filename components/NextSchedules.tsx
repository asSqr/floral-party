const NextSchedules = () => {
  return (
    <p className="pt-10 pb-10 text-lg leading-7 text-gray-900 dark:text-gray-100">
      次回は{' '}
      <span className="text-3xl text-primary-500 dark:hover:text-primary-400">3/23 (日)</span> に{' '}
      <span className="text-3xl text-primary-500 dark:hover:text-primary-400">新宿御苑</span> にて{' '}
      ...
      イベント詳細ページは{' '}
      <a
        href="https://22th-peach-quince-wind.peatix.com"
